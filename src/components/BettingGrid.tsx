...
const BettingGrid = () => {
  ...
  const getPlaceholderImage = (poolId: string) => {
    ...
    return (
      <div className="w-full h-full flex items-center justify-center bg-white text-sm font-bold" style={{
        color: textColor
      }}>
        {firstLetter}
      </div>
    ...
    return (
      <div className="flex -space-x-1 mr-2">
        {chipsToShow.map((chipGroup, index) => (
          <div key={`chip-${chipGroup.amount}-${index}`} className={cn("relative w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold text-white border border-white/40", getChipColor(chipGroup.amount))} style={{
            zIndex: 5 - index,
        ...
        {remainingDenoms > 0 && (
          <div className="w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold bg-black/50 border border-white/20 shadow-sm" style={{
            zIndex: 1,
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-white/80 text-lg mb-4 animate-pulse-subtle">Place your chips on the mining pool that will mine the next Bitcoin block &amp; win Sats!</p>
      </div>
      ...
      <Card className="w-full bg-[#0a0a0a] border-white/10 p-4 rounded-xl mb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2 w-full md:w-auto justify-end">
            <Button variant="outline" className="flex-1 md:flex-initial bg-btc-orange hover:bg-btc-orange/80 text-black border-btc-orange/50 hover:border-btc-orange/70 rounded-full" onClick={handleDeposit}>
              Deposit
            </Button>
            <Button variant="outline" className="flex-1 md:flex-initial border-btc-orange/20 bg-btc-orange/5 text-white hover:bg-btc-orange/10 hover:border-btc-orange/30 rounded-full" onClick={handleWithdraw}>
              Withdraw
            </Button>
          </div>
        </div>
